...
if (isset($_POST['Envoyer'])) {
    ...
    if (!empty($_FILES['image']) && $description != "" && $prix != "") {
        ...
        if ($deplacer_img) {
            ...
            $req = mysqli_query($con, "INSERT INTO vendu VALUES(NULL,'$nouveau_nom_img','$description', '$prix')");
            if ($req) {
            ...
            <table id="table">
                ...
                ?>
                        <tr>
                            ...
                            <td id="btn"><a href="modifiervendu.php?id=<?= $row['id'] ?>"><img src="images/pen.png"></a></td>
                            <td id="btn"><a href="deletevendu.php?id=<?= $row['id'] ?>"><img src="images/trash.png"></a></td>
                        </tr>
                <?php
                    }
                }
